...
namespace PubSubClient.Tests
{
    ...
    public class ActiveMqTests
    {
        ...
        private static ILogger<ActiveMqTests>? logger;
        ...
        public static async Task ClassInitialize(TestContext _)
        {
            ...
            hostBuilder.AddPubSubClient<ActiveMqConsumerService, ActiveMqPublisherService>();
            host = hostBuilder.Build();
            logger = host.Services.GetRequiredService<ILogger<ActiveMqTests>>();
